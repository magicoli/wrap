[unreleased]
* convert obsolete ereg_* function to preg
* use include path, insted of hard paths
* silent includes insted of file_exists checks
* external includes in contrib/ folder
